...
# HTML template (plain string, no f-strings). We replace %%DATA_JSON%% with the JSON payload.
html_template = """
<!doctype html>
<html lang="en">
<head>
...
html = html_template.replace('%%DATA_JSON%%', json.dumps(payload, ensure_ascii=False))
